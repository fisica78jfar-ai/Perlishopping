document.addEventListener("DOMContentLoaded", () => {
  ...
  const productGroups = [
...

   {
    ...
    { name: "Cremas Delight", price: 1, img: "img/HEB - Creams Delight.png" },
    { name: "Cremas Starbucks", price: 1, img: "img/HEB - Creams Starbucks.png" },
...

    {
      selector: ".disponible",
      products: [
        { name: "Cafetera Hamilton Beach (12 tazas)", price: 1, img: "img/W - coffee maker.png" },
        { name: "Plancha Black and Decker 'Even Steam'", price: 1, img: "img/W - plancha b&d.png" },
        { name: "Slow Cooker -H Beach", price: 1, img: "img/W - slow cooker.png" },
        { name: "Roku - HD", price: 1, img: "img/W-roku.png" },
        { name: "Odorizante y refills (combo para 1 año)", price: 1, img: "img/SC - scent booster.png" },
...

    {
      ...
      products: [
        ...
        { name: "Old spice -5pk 85g (grande)", price: 1, img: "img/SC - Old spice.png" },
        ...
        { name: "Gel - Bath and Body Works (5 piezas)", price: 1, img: "img/other gel.png" },
